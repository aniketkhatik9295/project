...
@WebServlet("/addtraveler")
public class addtraveler extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			travelerdetails u=new travelerdetails(travelername,manager,contact,address,password1);
